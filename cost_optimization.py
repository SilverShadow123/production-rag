...
class ModelRouter:
    ...
    def classify_complexity(self, query: str) -> str:
        prompt = f"""Classify this query's complexity as 'simple' or 'complex'.
...
Respond with only: simple or complex"""
        ...
        response = self._call(self.classifier_model, prompt)
